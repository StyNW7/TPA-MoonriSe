...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public CinemachineFreeLook playerCinemachineCamera;

        private bool cannotMove;

        [SerializeField] private bool isInDungeon = false;

        public bool GetCtrlKeyPressed()
        {
            return isCtrlKeyPressed;
        }

        public void SetCtrlKeyPressed()
        {
        ...
        private void Start()
        {
            ...
            // playerInventoryCamera.SetActive(false);
        ...
        private void AimShoot()
        {
            if (_input.isAiming && Grounded && !_input.sprint && 
                EquipmentManager.Instance.GetEquipmentWeapon() == "Bow")
            {
        ...
        private void Move()
        {
            ...
            targetSpeed = isCtrlKeyPressed ? SprintSpeed : MoveSpeed;
        ...
        public void CannotMove(bool yes){
            cannotMove = yes;
        }
