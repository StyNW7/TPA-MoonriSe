...
public class RuinsAreaManager : MonoBehaviour
{
    ...
    void OnConfirm()
    {
        ...
        float playerMaxHealth = playerManager.GetMaxHealth();
        ...
        // if (DataManager != null)
            DataManager.Instance.SaveGame(playerHealth, playerMaxHealth, playerLevel, playerMoney,
                playerExperience, worldLevel, ownedItems, ownedResources);
